<x-layout>
    ...
    <div class="card shadow-sm border-0 rounded-4 mb-4">
        <div class="card-body p-4 bg-white rounded-4">
            <div class="row g-3">
                <div class="col-12">
                    <h1 class="pb-4 fw-bold">Low Stocks</h1>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 px-4 py-3 border-bottom bg-light">
            <h6 class="m-0 fw-bold text-muted mode-title" id="modeTitle">Low Stock Products</h6>
        ...
        <div class="card-body p-0" id="tableContainer">
            <x-search-result :products="$products" :show-stock-out="true" />
        </div>
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $('#btnSubmitStock').click(function() {
                ...
                if (hasInvalidQty) {
                    alert(currentMode === 'Stock-Out' ? 'Stock-out quantity cannot exceed current stock and must be a positive number.' : 'Quantity must be a positive number.');
                    renderStockModalTable();
                    return;
                }
